...
def main():
    ...
    realtrain = train_cnn.train_model(args.imgpath, args.maskpath, args.labelpath,
                                      args.project_home_dir)  # ignore this returned epoch
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_dir", type=str, default='_thyroid_weighted_focal_extralinear_3rowstack_trainonly',
                        help="folder to save your trained model")  # set in function
    parser.add_argument("--pretrained_dir", type=str,
                        help="folder to save pretrained model weights for setup_model function")
    parser.add_argument("--imgpath", type=str, default="/path/to/imgs.hdf5",
                        help="path to img hdf5 file")  # CHANGE if required
    parser.add_argument("--maskpath", type=str, default="/path/to/masks.hdf5",
                        help="path to mask hdf5 file")  # CHANGE if required
    parser.add_argument("--labelpath", type=str, default="/path/to/labels.csv",
                        help="path to labels csv file")  # CHANGE if required
    parser.add_argument("--project_home_dir", type=str, default="/your/home/dir",
                        help="home project directory")  # CHANGE
